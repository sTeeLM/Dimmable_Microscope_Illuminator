...
void led_initialize(void)
{
  ...
  */  
  ...
  PCA_PWM0 = 0xc0; //PCA 模块0 输出10 位PWM，频率 时钟/(1024*12)
  PCA_PWM0 |= 0x3F;
  CCAP0L = 0xFF; //PWM 占空比为0%[(400H-400H)/400H]
  CCAP0H = 0xFF;
  
  CCAPM1 = 0x42; //PCA 模块1 为PWM工作模式，无中断
  PCA_PWM1 = 0xc0; //PCA 模块1 输出10 位PWM，频率 时钟/(1024*12)
  //PCA_PWM1 |= 0x3;
  CCAP1L = 0x20; //PWM 占空比为0%[(400H-400H)/400H]
  CCAP1H = 0x20;  
